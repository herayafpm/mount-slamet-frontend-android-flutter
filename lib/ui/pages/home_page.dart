              ...
              body: SafeArea(
                child: SingleChildScrollView(
                  ...
                  listener: (context, state) {
                    ...
                    } else if (state is BookingCekKetersediaanStateSuccess) {
                          ...
                          Form(
                              ...
                              child: Column(children: [
                                    ...
                                    children: [
                                      Obx(
                                        () => Txt(DateTimeUtil.toDateHumanize(
                                            bookingController.tglMasuk.value
                                                .toString())),
                                      ),
                                      IconButton(
                                ...
                                Parent(
                                  child: Row(
                                    ...
                                    children: [
                                      Obx(
                                        () => Txt(DateTimeUtil.toDateHumanize(
                                            bookingController.tglKeluar.value
                                                .toString())),
                                      ),
                                      IconButton(
                                        icon: Icon(Icons.calendar_today,
                                ...
                                Obx(() => MyButtonComp(
                                    ...
                                    title: (controller.userModel.value.isAdmin)
                                        ? "Download"
                                        : "Cek Ketersediaan",
                                    color: Colors.blue,
                                    onTap: (bookingController.isLoading.value)
                                        ...
                                        : () {
                                            if (controller
                                              ...
                                              bookingController.laporan(bloc);
                                            } else {
